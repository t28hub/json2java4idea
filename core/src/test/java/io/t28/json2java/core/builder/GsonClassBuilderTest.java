...
public class GsonClassBuilderTest {
    private GsonClassBuilder underTest;

    @Before
    public void setUp() throws Exception {
        underTest = new GsonClassBuilder(
    ...
    public void buildFields() throws Exception {
        ...
        assertThat(actual.get(0))
                ...
                .isFinal()
                .hasNoInitializer()
                .hasAnnotation(AnnotationSpec.builder(SerializedName.class)
