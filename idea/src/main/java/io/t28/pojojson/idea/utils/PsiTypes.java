...
public class PsiTypes implements Function<TypeName, PsiType> {
    private final PsiManager psiManager;

    public PsiTypes(@Nonnull Project project) {
        this(PsiManager.getInstance(project));
    }

    @VisibleForTesting
    PsiTypes(@Nonnull PsiManager psiManager) {
